...
# region Initialize PCBLS parameters
...
print("MAE PCBLS Train TCO:", mae_BLS_Train_TCO)
print("MAE PCBLS Train P:", mae_BLS_Train_P)
print("RMSE PCBLS Train TCO:", rmse_BLS_Train_TCO)
print("RMSE PCBLS Train P:", rmse_BLS_Train_P)
print("R^2 PCBLS Train TCO:", r2_BLS_Train_TCO)
print("R^2 PCBLS Train P:", r2_BLS_Train_P)
print("MAPE PCBLS Train TCO:", mape_BLS_Train_TCO)
print("MAPE PCBLS Train P:", mape_BLS_Train_P)
print("MSE PCBLS Train TCO:", mse_BLS_Train_TCO)
print("MSE PCBLS Train P:", mse_BLS_Train_P)
print("loss_energy PCBLS Train:", loss_energy_BLS_Train)
print("loss PCBLS Train:", loss_BLS_Train)
# dataset2832 is used in Scenario 1, and dataset283230fp is used in Scenario 2
COP_train = 6330 * dataset2832[:, 8] / best_y_train[:, 1]
COP_train = pd.DataFrame(COP_train)
#COP_train.to_csv('NETOUT_TRAIN_PCBLS_COP_fp_1.csv')
best_y_train = pd.DataFrame(best_y_train)
#best_y_train.to_csv('NETOUT_TRAIN_PCBLS_TCO_P_fp_1.csv')
...
error_Test.to_csv('NETOUT_TEST_PCBLS_error_fp_1.csv')
print('Testing accuracy indicators')
print("MAE PCBLS Test TCO:", mae_BLS_Test_TCO)
print("MAE PCBLS Test P:", mae_BLS_Test_P)
print("RMSE PCBLS Test TCO:", rmse_BLS_Test_TCO)
print("RMSE PCBLS Test P:", rmse_BLS_Test_P)
print("R^2 PCBLS Test TCO:", r2_BLS_Test_TCO)
print("R^2 PCBLS Test P:", r2_BLS_Test_P)
print("MAPE PCBLS Test TCO:", mape_BLS_Test_TCO)
print("MAPE PCBLS Test P:", mape_BLS_Test_P)
print("MSE PCBLS Test TCO:", mse_BLS_Test_TCO)
print("MSE PCBLS Test P:", mse_BLS_Test_P)
print("loss_energy PCBLS Test:", loss_energy_BLS_Test)
print("loss PCBLS Test:", loss_BLS_Test)
COP_test = 6330 * dataset7_30[:, 8] / y_test[:, 1]
COP_test = pd.DataFrame(COP_test)
#COP_test.to_csv('NETOUT_TEST_PCBLS_COP_fp_1.csv')
y_test = pd.DataFrame(y_test)
#y_test.to_csv('NETOUT_TEST_PCBLS_TCO_P_fp_1.csv')
